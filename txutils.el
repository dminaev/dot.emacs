...
;;; Copyright (C) 2006. Tim Cross <[EMAIL PROTECTED]>
;;; All Rights Reserved.
;;;
...
;;; always welcome. Send e-mail to [EMAIL PROTECTED]
;;;
...
(defcustom txutils-convert-alist
  '( ;; MS Word
    ("\\.\\(?:DOC\\|doc\\)$"     doc  "/usr/bin/catdoc"    nil nil nil nil nil)
    ;; PDF
    ("\\.\\(?:PDF\\|pdf\\)$"     pdf  "/usr/bin/pdftotext" nil nil nil nil nil)
    ;; PostScript
    ("\\.\\(?:PS\\|ps\\)$"       ps   "/usr/bin/pstotext"  "-output" t nil nil 
     nil)
    ;; MS PowerPoint
...
;    (if (string-match "\\(?:HTML?\\|html?\\)$" (ad-get-arg 0))
    (if (string-match "\\(?:HTML?\\|html?\\|fb2?\\)$" (ad-get-arg 0))
